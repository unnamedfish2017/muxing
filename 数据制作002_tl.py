...
path='/home/jovyan/data/store/rsync/tonglian_data_daily/tonglian_data_daily.pickle'
...
tp=tp[clms]
tp=tp.tail(320).stack().reset_index().iloc[:,:2]
tp.columns=['日期','股票代码']
n_prd=5
...
params={
'path':'/home/jovyan/data/store/rsync/tonglian_data_daily/tonglian_data_daily.pickle',
'path_':'/home/jovyan/data/store/rsync/tonglian_data_daily/tonglian_stock_day_n.parquet',

'通联因子路径':f'{DATA_PATH}/factor_data/A股精品因子数据.parquet',
'日线常规因子路径':f'{DATA_PATH}/tonglian_data_daily/tonglian_日线常规指标.parquet',
'个股因子路径':f'{DATA_PATH}/tonglian_factor_data/日线因子_p1/',
'大盘因子路径':f'{DATA_PATH}/tonglian_factor_data/大盘因子/',
...
'原始行情因子路径':f'{DATA_PATH}/tonglian_data_daily/tonglian_stock_day_n.parquet',
'高频因子路径':f'{DATA_PATH}/factor_data/高频因子_p2/',
'高频衍生因子路径':f'{DATA_PATH}/tonglian_factor_data/高频衍生因子',
...
df_prevday_facts_raw.to_parquet(f'{root}/%s_prevday_daily_facts_full_002_tl.parquet'%nxt_trd_day_)
df_60d_facts_raw.to_parquet(f'{root}/%s_60d_daily_facts_small_002_tl.parquet'%nxt_trd_day_)