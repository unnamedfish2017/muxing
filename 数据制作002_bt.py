...
df_prevday_facts_raw.to_parquet(f'{root}/%s_prevday_daily_facts_full_002_bt.parquet'%nxt_trd_day_)
df_60d_facts_raw.to_parquet(f'{root}/%s_60d_daily_facts_small_002_bt.parquet'%nxt_trd_day_)